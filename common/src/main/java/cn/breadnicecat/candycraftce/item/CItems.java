...
public class CItems {
	...
	public static final ItemEntry<Item> CANDY_CANE = create("candy_cane").setFood(1, 1f).save();
	public static final ItemEntry<Item> CHEWING_GUM = create("chewing_gum").setFood(1, 0f).save();
	public static final ItemEntry<Item> LOLLIPOP = create("lollipop").setFood(1, 1f).save();
	public static final ItemEntry<Item> CHOCOLATE_LEAF = create("chocolate_leaf").setFood(1, 1f).save();
	public static final ItemEntry<Item> WHITE_CHOCOLATE_LEAF = create("white_chocolate_leaf").setFood(1, 1f).save();
